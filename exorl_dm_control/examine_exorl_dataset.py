...
def examine_raw_dataset(buffer_dir):
...
def main():
    ...
    # examine_raw_dataset(buffer_dir)

    # HDF5
    ds_path = "/home/ekuo/bisim/exorl/datasets/point_mass_maze/rnd/displacement_discretized.hdf5"
