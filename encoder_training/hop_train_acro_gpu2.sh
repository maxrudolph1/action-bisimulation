...
python main.py algos='[acro]' n_epochs=35 algos.acro.l1_penalty=0.0002 algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=3 wandb=True train_evaluators=False eval_encoder='acro'
...
python main.py algos='[acro]' n_epochs=35 algos.acro.l1_penalty=0.002  algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=3 wandb=True train_evaluators=False eval_encoder='acro'
...
python main.py algos='[acro]' n_epochs=35 algos.acro.l1_penalty=0.02   algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=3 wandb=True train_evaluators=False eval_encoder='acro'
python main.py algos='[acro]' n_epochs=35 algos.acro.l1_penalty=0.05   algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=3 wandb=True train_evaluators=False eval_encoder='acro'
python main.py algos='[acro]' n_epochs=35 algos.acro.l1_penalty=0.1    algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=3 wandb=True train_evaluators=False eval_encoder='acro'
