...
python main.py algos='[multi_step]' algos.multi_step.gamma=0.6 algos.multi_step.use_states_with_same_action=True algos.multi_step.reset_forward_model_every=40000 wandb=True
python main.py algos='[multi_step]' algos.multi_step.gamma=0.7 algos.multi_step.use_states_with_same_action=True algos.multi_step.reset_forward_model_every=40000 wandb=True
