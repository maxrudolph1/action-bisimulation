# python main.py algos='[acro]' n_epochs=80 algos.acro.l1_penalty=0.5    algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=2 wandb=True
# python main.py algos='[acro]' n_epochs=80 algos.acro.l1_penalty=0.2    algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=2 wandb=True
# python main.py algos='[acro]' n_epochs=80 algos.acro.l1_penalty=0.1    algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=2 wandb=True
# python main.py algos='[acro]' n_epochs=80 algos.acro.l1_penalty=0.05   algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=2 wandb=True
# python main.py algos='[acro]' n_epochs=80 algos.acro.l1_penalty=0.02   algos.acro.dynamic_l1_penalty=False algos.acro.k_steps=2 wandb=True
...
python main.py algos='[acro]' n_epochs=14 algos.acro.k_steps=1 wandb=True
