...
# MS_ACRO K=2
python main.py use_wandb=True env.grid_size=30 env.num_obstacles=100 env.max_timesteps=170 exp_name="sp_ms_acro_k2" seed=3 encoder.latent_encoder_path="/home/ekuo/bisim/action-bisimulation/saved_models/grid_30_obstcls_100_smpls_1250000/ms_acro_k2_l1_002_swps_gamma_0.8.pt"
python main.py use_wandb=True env.grid_size=30 env.num_obstacles=100 env.max_timesteps=170 exp_name="sp_ms_acro_k2" seed=5 encoder.latent_encoder_path="/home/ekuo/bisim/action-bisimulation/saved_models/grid_30_obstcls_100_smpls_1250000/ms_acro_k2_l1_002_swps_gamma_0.8.pt"
python main.py use_wandb=True env.grid_size=30 env.num_obstacles=100 env.max_timesteps=170 exp_name="sp_ms_acro_k2" seed=7 encoder.latent_encoder_path="/home/ekuo/bisim/action-bisimulation/saved_models/grid_30_obstcls_100_smpls_1250000/ms_acro_k2_l1_002_swps_gamma_0.8.pt"

# MS_ACRO K=3
python main.py use_wandb=True env.grid_size=30 env.num_obstacles=100 env.max_timesteps=170 exp_name="sp_ms_acro_k3" seed=3 encoder.latent_encoder_path="/home/ekuo/bisim/action-bisimulation/saved_models/grid_30_obstcls_100_smpls_1250000/ms_acro_k3_l1_0002_swps_gamma_0.85.pt"
python main.py use_wandb=True env.grid_size=30 env.num_obstacles=100 env.max_timesteps=170 exp_name="sp_ms_acro_k3" seed=5 encoder.latent_encoder_path="/home/ekuo/bisim/action-bisimulation/saved_models/grid_30_obstcls_100_smpls_1250000/ms_acro_k3_l1_0002_swps_gamma_0.85.pt"
python main.py use_wandb=True env.grid_size=30 env.num_obstacles=100 env.max_timesteps=170 exp_name="sp_ms_acro_k3" seed=7 encoder.latent_encoder_path="/home/ekuo/bisim/action-bisimulation/saved_models/grid_30_obstcls_100_smpls_1250000/ms_acro_k3_l1_0002_swps_gamma_0.85.pt"
